...
También existe un archivo llamado CA_category_id el cual contiene cada categoría (categoryId) a la cual puede pertenecer cada video. Las columnas de este archivo son las siguientes:

-   kind (La clase correspondiente al dato, en este caso fijada a "youtube#guideCategory")
